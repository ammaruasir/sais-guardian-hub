...
export const seedRoles: Role[] = [
  ...
  },
  {
    ...
    description: "إدارة الاستراتيجيات والأهداف والمبادرات",
    system: false,
  },
  {
    key: "kpi_manager",
    nameAr: "مدير مؤشرات الأداء",
    description: "إدارة مؤشرات الأداء والمخاطر والتقارير",
    system: false,
  },
...
export const seedUsers: AdminUser[] = [
  {
    ...
    email: "khaled@sais.gov.sa",
    roleKey: "department_head",
    department: "إدارة المراجعات",
    active: true,
    events: 0,
  },
  {
  ...
  {
    id: "u3",
    nameAr: "م. نورة الشمري",
    email: "noura@sais.gov.sa",
    roleKey: "department_head",
  ...
  {
    id: "u4",
    nameAr: "م. عبدالله الدوسري",
    email: "abdullah@sais.gov.sa",
    roleKey: "data_entry",
  ...
  {
    id: "u5",
    nameAr: "أ. سارة العتيبي",
    email: "sara@sais.gov.sa",
    roleKey: "super_admin",
  ...
  {
    id: "u6",
    nameAr: "أ. محمد الراشد",
    email: "mohammad@sais.gov.sa",
    roleKey: "admin",
    department: "تقنية المعلومات",
    active: true,
    events: 1315,
  ...
  {
    id: "u8",
    nameAr: "أ. سلطان المالكي",
    email: "sultan@sais.gov.sa",
    roleKey: "viewer",
  ...
  {
    id: "u9",
    nameAr: "أ. هند المطيري",
    email: "hind@sais.gov.sa",
    roleKey: "department_head",
    department: "إدارة المراجعات",
    active: true,
    events: 3,
...
export const seedAuditEvents: AuditEvent[] = [
  {
    ...
    user: "Admin User",
    type: "مغادرة التبويب",
    description: "مغادرة التبويب",
    page: "settings/",
    level: "info",
    ts: "2026-05-04T22:50:00",
  },
  {
    id: "ev2",
    user: "Admin User",
    type: "فقدان التركيز",
    description: "فقدان التركيز على النافذة (احتمال التقاط شاشة)",
    page: "settings/",
    level: "info",
    ts: "2026-05-04T22:50:30",
  },
  {
    id: "ev3",
    user: "م. خالد الحربي",
    ...
    page: "login",
    level: "info",
    ts: "2026-05-04T09:15:00",
  },
  {
    id: "ev4",
    user: "م. فهد القحطاني",
    type: "تعديل مشروع",
    description: "تعديل حالة مشروع منشأة حائل",
    page: "projects/p5",
    level: "info",
  ...
  },
  {
    ...
    description: "3 محاولات فاشلة من IP 192.168.1.105",
    page: "login",
    level: "warning",
    ts: "2026-05-04T03:22:00",
  },
  {
    id: "ev6",
    user: "أ. سارة العتيبي",
    type: "تغيير صلاحيات",
    description: "تعديل دور المستخدم فهد القحطاني",
    page: "admin/users",
    level: "warning",
    ts: "2026-05-03T14:00:00",
  },
  {
    id: "ev7",
    user: "Admin User",
    type: "تصدير بيانات",
    description: "تصدير قائمة المشاريع",
    page: "projects/",
    level: "info",
    ts: "2026-05-03T16:45:00",
  },
  {
    id: "ev8",
    user: "Unknown",
    type: "محاولة دخول فاشلة",
    description: "5 محاولات فاشلة - تم قفل الحساب",
    page: "login",
    level: "critical",
    ts: "2026-05-03T01:15:00",
  },
  {
    id: "ev9",
    user: "م. نورة الشمري",
    type: "اعتماد مشروع",
    description: "اعتماد المرحلة 4 لمصفاة جازان",
    page: "projects/p12",
    level: "info",
    ts: "2026-05-02T11:20:00",
  },
  {
    id: "ev10",
    user: "Admin User",
    type: "تعديل إعدادات",
    description: "تغيير سياسة كلمة المرور",
    page: "settings/",
    level: "warning",
  ...
  {
    id: "ev11",
    user: "م. عبدالله الدوسري",
    type: "فقدان التركيز",
    description: "فقدان التركيز أثناء مراجعة مستندات سرية",
    page: "projects/p1",
    level: "warning",
    ts: "2026-05-01T15:30:00",
  },
  {
    id: "ev12",
    user: "Admin User",
    type: "إنشاء مستخدم",
    description: "إضافة مستخدم جديد: ريم الحربي",
    page: "admin/users",
    level: "info",
    ts: "2026-05-01T08:00:00",
  },
  {
    id: "ev13",
    user: "Unknown",
    type: "محاولة وصول غير مصرح",
    description: "محاولة وصول من IP محظور",
    page: "admin/",
    level: "critical",
    ts: "2026-04-30T22:00:00",
  },
  {
    id: "ev14",
    user: "أ. محمد الراشد",
    ...
    page: "admin/settings",
    level: "info",
    ts: "2026-04-30T02:00:00",
  },
  {
    id: "ev15",
    user: "م. فهد القحطاني",
    type: "رفض مشروع",
    description: "رفض تقديم المرحلة 1 لمنشأة حائل",
    page: "projects/p5",
    level: "info",
    ts: "2026-04-29T14:15:00",
  },
];
