...
export const projects: Project[] = [
  {
    id: "p1",
    nameAr: "توسعة رأس تنورة",
    nameEn: "Ras Tanura Expansion",
    companyId: "aramco",
    facilityAr: "مصفاة رأس تنورة",
    sector: "petroleum",
  ...
  {
    id: "p2",
    nameAr: "مصنع الجبيل الجديد",
    nameEn: "Jubail New Plant",
    companyId: "sabic",
    facilityAr: "مجمع الجبيل البتروكيماوي",
    sector: "petrochemicals",
    classification: "high",
    stage: 1,
    status: "under_review",
  ...
  {
    id: "p3",
    nameAr: "تطوير وعد الشمال",
    nameEn: "Wa'ad Al Shamal Upgrade",
    companyId: "maaden",
    facilityAr: "مجمع وعد الشمال للفوسفات",
    sector: "mining",
    classification: "high",
    stage: 4,
  ...
  {
    id: "p4",
    nameAr: "محطة الرياض الغربية",
    nameEn: "Riyadh West Substation",
    companyId: "sec",
    facilityAr: "محطة تحويل الرياض الغربية",
    sector: "power",
  ...
  {
    id: "p6",
    nameAr: "خط أنابيب الشرقية",
    nameEn: "Eastern Pipeline",
    companyId: "aramco",
    facilityAr: "خط أنابيب الشرقية",
    sector: "petroleum",
    classification: "critical",
    stage: 3,
    status: "under_review",
  ...
  {
    id: "p7",
    nameAr: "مجمع ينبع للأوليفينات",
    nameEn: "Yanbu Olefins Complex",
    companyId: "sabic",
    facilityAr: "مجمع ينبع",
    sector: "petrochemicals",
    classification: "high",
    stage: 2,
    status: "under_review",
  ...
  {
    id: "p8",
    nameAr: "محطة القصيم الكهربائية",
    nameEn: "Qassim Power Plant",
    companyId: "sec",
    facilityAr: "محطة القصيم",
    sector: "power",
    classification: "high",
    stage: 3,
    status: "approved",
  ...
  {
    id: "p9",
    nameAr: "ميناء جدة الجنوبي",
    nameEn: "South Jeddah Port",
    companyId: "aramco",
    facilityAr: "ميناء جدة",
    sector: "other",
    classification: "high",
    stage: 4,
    status: "under_review",
  ...
  {
    id: "p10",
    nameAr: "مصنع الأسمنت الجنوبي",
    nameEn: "Southern Cement Plant",
    companyId: "almarai",
    facilityAr: "مصنع الجنوب",
    sector: "industrial",
    classification: "low",
    stage: 2,
  ...
  },
  {
    id: "p11",
    nameAr: "منجم الزبيرة",
    nameEn: "Az Zabirah Mine",
    companyId: "maaden",
    facilityAr: "منجم الزبيرة",
    sector: "mining",
    classification: "high",
    stage: 3,
    status: "under_review",
...
export const activity: ActivityItem[] = [
  {
    ...
    ts: "قبل 12 دقيقة",
    who: "م. خالد الحربي",
    ar: "اعتمد المرحلة 2 لمشروع محطة الرياض الغربية",
    type: "approved",
  },
  {
    id: "a2",
    ts: "قبل 45 دقيقة",
    who: "أرامكو السعودية",
    ar: "قدّمت تحديث المستندات لمشروع توسعة رأس تنورة",
    type: "submitted",
  },
  {
    id: "a3",
    ts: "قبل ساعة",
    who: "م. فهد القحطاني",
    ar: "طلب مستندات إضافية لمشروع منشأة معالجة حائل",
    type: "requested",
  },
  {
    id: "a4",
    ts: "قبل 3 ساعات",
    who: "سابك",
    ar: "قدّمت المرحلة 1 لمشروع مصنع الجبيل الجديد",
    type: "submitted",
  },
  {
    id: "a5",
    ts: "أمس",
    who: "م. نورة الشمري",
    ar: "أضافت تعليقاً على مشروع تطوير وعد الشمال",
    type: "comment",
  },
  {
    id: "a6",
    ts: "أمس",
    who: "م. عبدالله الدوسري",
    ar: "أنهى زيارة تفتيش لميناء جدة الجنوبي",
    type: "approved",
  },
];
