...
export const consultants: Consultant[] = [
  {
    id: "c1",
    nameAr: "الجزيرة للاستشارات الأمنية",
    nameEn: "AJEC",
    licenseNo: "SAIS-LIC-2023-018",
  ...
  {
    id: "c2",
    nameAr: "شركة TEC للاستشارات",
    nameEn: "TEC Consulting",
    licenseNo: "SAIS-LIC-2024-042",
    specializations: ["safety_fire"],
    activeProjects: 3,
    licenseExpiry: "2026-11-20",
    status: "active",
    phone: "+966 12 345 6789",
    email: "contact@tec.sa",
  },
  {
    id: "c3",
    nameAr: "مجموعة SGW الاستشارية",
    nameEn: "SGW Group",
    licenseNo: "SAIS-LIC-2023-027",
  ...
  {
    id: "c4",
    nameAr: "ساسيكون للاستشارات الأمنية",
    nameEn: "SASECON",
    licenseNo: "SAIS-LIC-2024-051",
    specializations: ["both"],
    activeProjects: 2,
    licenseExpiry: "2026-09-12",
    status: "active",
    phone: "+966 11 987 6543",
    email: "hello@sasecon.sa",
  },
  {
    id: "c5",
    nameAr: "المتحدة للحلول الأمنية",
    nameEn: "United Security Solutions",
    licenseNo: "SAIS-LIC-2022-009",
    specializations: ["security"],
    activeProjects: 1,
    licenseExpiry: "2026-06-01",
    status: "pending_renewal",
    phone: "+966 14 222 3344",
    email: "info@united-ss.sa",
  },
];
