    ...
    <Card className="cursor-pointer p-3 transition hover:shadow-md" onClick={onClick}>
      ...
      <div className="flex items-center justify-between gap-2 text-xs">
        <div className="flex items-center gap-1.5">
          ...
          <span className="truncate text-muted-foreground">{assignee?.nameAr.replace("م. ", "")}</span>
        </div>
        <div className={`num flex items-center gap-1 ${task.overdue ? "text-destructive font-semibold" : "text-muted-foreground"}`}>
